...
title: "#4 iterazione – Rendere l'applicazione ad accoppiamento libero (C ) Documenti Microsoft"
...
ms.locfileid: "81542365"
---
# <a name="iteration-4--make-the-application-loosely-coupled-c"></a>Iterazione 4 - Rendere l'applicazione a regime di controllo libero (C#)

da parte [di Microsoft](https://github.com/microsoft)

[Scarica il codice](iteration-4-make-the-application-loosely-coupled-cs/_static/contactmanager_4_cs1.zip)
...
**Listato 1 - Modelli: IContactManagerRepository.csListing 1 - Models,IContactManagerRepository.cs**
...
**Listato 2 - Modelli, EntityContactManagerRepository.cs**
...
**Listato 4 - Modelli: ContactManagerService.cs**
...
**Listato 5 - Modelli: IContactManagerService.cs**
...
**Listato 6 - Controller-ContactController.cs**
...
**Listato 7 - Modelli, Convalida, ModelStateWrapper.cs**

[!code-csharp[Main](iteration-4-make-the-application-loosely-coupled-cs/samples/sample7.cs)]

**Listato 8 - Modelli, Convalida, IValidationDictionary.cs**
