...
[Scarica il codice](iteration-7-add-ajax-functionality-vb/_static/contactmanager_7_vb1.zip)
...
[![Aggiornamento solo dei contatti](iteration-7-add-ajax-functionality-vb/_static/image1.jpg)](iteration-7-add-ajax-functionality-vb/_static/image1.png)

**Figura 01**: Aggiornamento solo[contatti(Fare clic per visualizzare l'immagine a dimensioni intere)](iteration-7-add-ajax-functionality-vb/_static/image2.png)
...
[![La pagina di conferma dell'eliminazione](iteration-7-add-ajax-functionality-vb/_static/image2.jpg)](iteration-7-add-ajax-functionality-vb/_static/image3.png)

**Figura 02**: La pagina di conferma dell'eliminazione[(Fare clic per visualizzare l'immagine a dimensioni intere)](iteration-7-add-ajax-functionality-vb/_static/image4.png)
...
> [Indietro](iteration-6-use-test-driven-development-vb.md)
