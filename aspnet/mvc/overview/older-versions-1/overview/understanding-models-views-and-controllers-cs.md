...
Un controller è semplicemente una classe, ad esempio una Visual Basic o una classe C#. L'applicazione ASP.NET MVC di esempio include un controller denominato HomeController.cs che si trova nella cartella Controllers. Il contenuto del file HomeController.cs viene riprodotto nel listato 2.
