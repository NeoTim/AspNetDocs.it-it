...
**Listato 3 – Controller- BadUserController.vb**
...
**Listato 4 – Controller/Controlloutente.vb**

[!code-vb[Main](improving-performance-with-output-caching-vb/samples/sample4.vb)]

Si noti che l'attributo &lt;OutputCache&gt; nel listato 4 include una proprietà Location impostata sul valore OutputCacheLocation.Client. L'attributo &lt;OutputCache include anche una proprietà NoStore.The OutputCache&gt; attribute also includes a NoStore property. Il NoStore proprietà viene utilizzata per informare i server proxy e browser che non devono archiviare una copia permanente del contenuto memorizzato nella cache.
...
**Listato 5 – Controller-MoviesController.vb**
...
Il controller nel listato 7 illustra come è possibile applicare il &lt;profilo&gt; Cache1Hour a un'azione del controller con il OutputCache attributo.
