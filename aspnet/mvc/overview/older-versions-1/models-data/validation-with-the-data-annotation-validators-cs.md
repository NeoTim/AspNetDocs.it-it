...
**Figura 1:** aggiunta di un riferimento al raccoglitore di modelli di annotazioni dei dati[(Fare clic per visualizzare l'immagine a dimensioni intere](validation-with-the-data-annotation-validators-cs/_static/image3.png))
...
Questa riga di codice registra ataAnnotationsModelBinder come gestore di associazione del modello predefinito per l'intera ASP.NET applicazione MVC.
...
**Figura 6**: Utilizzo di validator con Entity Framework ([Fare clic per visualizzare l'immagine a dimensioni intere](validation-with-the-data-annotation-validators-cs/_static/image14.png))
