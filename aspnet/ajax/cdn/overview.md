...
Se si vuole inviare la libreria JavaScript e la libreria è una delle librerie JavaScript principali (elencate in http://trends.builtwith.com) o estensioni/plug-in di queste librerie che sono (a) popolari oppure (b) utili per l'uso in ASP.NET, contattare AjaxCDNSubmission@Microsoft.com .
...
- La libreria dell'interfaccia utente jQuery &mdash; la libreria dell'interfaccia utente jQuery contiene tutti gli effetti dell'interfaccia utente jQuery e i widget come il widget DatePicker usato nella pagina precedente.
- Tema dell'interfaccia utente jQuery &mdash; l'interfaccia utente di jQuery supporta temi diversi. La pagina precedente include un collegamento a un file CSS per importare il tema Redmond.
...
#### <a name="bootstrap-version-452"></a>Versione bootstrap 4.5.2
...
#### <a name="bootstrap-version-450"></a>Versione bootstrap 4.5.0
...
Le versioni seguenti delle [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") versioni di bootstrap TouchCarousel sono ospitate nella rete CDN:
...
#### <a name="aspnet-mvc-51"></a>MVC 5,1 DI ASP.NET

- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-50"></a>MVC 5,0 DI ASP.NET
...
#### <a name="aspnet-mvc-20"></a>MVC 2,0 DI ASP.NET
...
#### <a name="aspnet-signalr-221"></a>SignalR 2.2.1 ASP.NET

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.js

#### <a name="aspnet-signalr-220"></a>2.2.0 SignalR ASP.NET

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.js

#### <a name="aspnet-signalr-210"></a>2.1.0 SignalR ASP.NET

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.js

#### <a name="aspnet-signalr-203"></a>2.0.3 SignalR ASP.NET
...
#### <a name="aspnet-signalr-111"></a>SignalR 1.1.1 ASP.NET

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.js

#### <a name="aspnet-signalr-110"></a>SignalR 1.1.0 ASP.NET
